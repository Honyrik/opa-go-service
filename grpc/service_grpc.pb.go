...
func (c *apiClient) Execute(ctx context.Context, in *ApiRequest, opts ...grpc.CallOption) (*ApiResult, error) {
	out := new(ApiResult)
	err := c.cc.Invoke(ctx, "/OPA.Api/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApiServer interface {
	Execute(context.Context, *ApiRequest) (*ApiResult, error)
...
func _Api_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/OPA.Api/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServer).Execute(ctx, req.(*ApiRequest))
	}
